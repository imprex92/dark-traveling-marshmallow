    ...
    <div className="recipt-container">
      ...
      <div className="recipt-wrapper container">
        <ul className="collapsible">
          <li
            className={`collapsible-upload active ${userDefinedFile ? 'hasDefinedFile' : ''} ${userDefinedCameraFile ? 'hasDefinedCameraFile' : ''}`}
          >
                ...
                <form id="receipt-form" action="#" className="col s12">
                  ...
                  <div className="row">
                    <div className="file-field input-field col s12 cameraFile">
                      <div
                        className={`btn-small ${userDefinedFile && 'disabled'}`}
                      >
                        <span>Camera</span>
                        ...
                        <input
                          ...
                          onChange={(e) => handleimageUpload(e, 'CAMERA_FILE')}
                        />
                      </div>
                  ...
                  <div className="row">
                    <div className="file-field input-field col s12 localeFile">
                      <div
                        className={`btn-small ${userDefinedCameraFile && 'disabled'}`}
                      >
                        <span>File</span>
                        <i className="material-icons left">attach_file</i>
                        <input
                          disabled={userDefinedCameraFile}
                          type="file"
                          accept="image/*"
                          onChange={(e) => handleimageUpload(e, 'ATTACH_FILE')}
                        />
                      </div>
                      <div className="file-path-wrapper">
                        <input className="file-path validate" type="text" />
                  ...
                  {isUploading ? (
                    <ProgressBar
                      ...
                      fireError={setHasError}
                      setUploadedURL={setUploadedURL}
                      initiator="RECIPE_UPLOAD"
                      reciptFile={userDefinedCameraFile || userDefinedFile}
                    />
                  ) : null}
                </form>
              </div>
              {hasError ? (
                <div className="white-text red darken-4 fileinput-error">
                  <strong>{hasError}</strong>
                </div>
              ) : null}
              {isSuccessful && (
                <div className="white-text green fileinput-error">
        ...
        <div
          className="collapsible-header gallery"
      ...
      <style jsx scoped>{`
        ...
        .collapsible-upload.hasDefinedCameraFile
          .file-field.input-field.col.s12.cameraFile
          input,
        .collapsible-upload.hasDefinedFile
          .file-field.input-field.col.s12.localeFile
          input {
          width: 100%;
        }
