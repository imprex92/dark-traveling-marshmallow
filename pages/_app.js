    ...
    <>
      <AuthProvider>
        ...
        <Script
          ...
          data-cbid="f5fc7d0f-f0b3-46eb-b262-434f483563e1"
          type="text/javascript"
          async
        />
        <Script
          strategy="afterInteractive"
          src={`https://www.googletagmanager.com/gtag/js?id=${process.env.NEXT_PUBLIC_PROJECT_FIREBASE_MEASUREMENT_ID}`}
        />
        <Script
        ...
        />
        {isOnline && !widgetProhibited.includes(router.pathname) ? (
          <WeatherWidget />
        ) : null}
