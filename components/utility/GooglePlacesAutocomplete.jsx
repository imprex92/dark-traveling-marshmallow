...
const PlacesAutocomplete = ({
  ...
  return (
    <div
      className={`input-field s11 col l5 places-autocomplete ${styles.placesAutocomplete}`}
      ref={ref}
    >
      ...
      />
      <label
        className={isDisabled ? styles.label_disabled : ''}
      ...
      <i
        ...
        className={`material-icons suffix ${isDisabled ? styles.pinIcon_disabled : styles.pinIcon}`}
      >
        person_pin_circle
      </i>
      {status === 'OK' && (
