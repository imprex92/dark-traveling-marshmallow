  ...
  return (
    <>
      <div className={`popup popup-${i} ${popup === i ? 'active' : ''}`}>
        <div
          className="close-btn material-icons"
          onClick={(e) => {
        ...
        <p>
          ...
          quibusdam omnis repellendus, atque similique magnam alias recusandae
          veniam, quisquam magni, itaque quaerat dolor? Veniam animi
          exercitationem at quasi molestiae! Doloremque.
        </p>
      </div>
      <style jsx scoped>{`
        .close-btn {
