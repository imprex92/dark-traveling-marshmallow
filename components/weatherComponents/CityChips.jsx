...
import { addWeatherChip, fetchUserWeatherChips, removeWeatherChip } from 'components/utility/subscriptions'
...
const CityChips = ({ currentUser, fetchWeather }) => {
  ...
  async function fetchTags() {
    await fetchUserWeatherChips(currentUser.uid)
      .then(data => { { initializeChips(data[0].tags), updateWeatherChips(data[0].tags)} })
