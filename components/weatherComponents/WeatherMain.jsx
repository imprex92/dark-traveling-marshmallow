...
const WeatherMain = ({
  ...
  return (
    <>
      <div id="mainContent" className={styles.weatherContainersContainer}>
          ...
          <div className={styles.currentWrapper}>
            ...
            <div className="row valign-wrapper">
              <form className="col s11 offset-s1 m12 searchbar-section">
                <div className="row">
                  <div
                    className={`${styles.searchBox} input-field col s11 m8 offset-m2`}
                  >
                    <i
                      className="material-icons suffix"
                      onClick={() => handleSearch(searchBox.current.value)}
                    >
                      search
                    </i>
                    <input
                      type="search"
                      className={`white-text validate ${apiError ? 'invalid' : 'valid'}`}
                      onKeyDownCapture={(e) =>
                    ...
                    <span
                      ...
                      data-error="Something went wrong. Did you spell correctly?"
                    ></span>
                  </div>
                </div>
              </form>
